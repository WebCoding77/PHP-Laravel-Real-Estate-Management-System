                      ...
                      <div class="col-md-3">
                        ...
                        <div class="select-wrap">
                          ...
                          <select name="select_city" id="select-city" class="form-control d-block rounded-0">
                            ...
                            <option value="Cairo">Los Angeles</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-3">
                  ...
                  <div class="col-md-12">
                    <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                      ...
                      <div class="ml-auto d-flex align-items-center">
                        <div>
                          <a href="{{ route('home') }}" class="text-decoration-none  view-list px-3 border-right active">All</a>
                          <a href="{{ route('buy.prop') }}" class="text-decoration-none  view-list px-3 border-right">Rent</a>
                          <a href="{{ route('rent.prop') }}" class="text-decoration-none  view-list px-3">Buy</a>
                          <a href="{{ route('price.asc.prop') }}" class="text-decoration-none  view-list px-3">By Price Ascending</a>
                          <a href="{{ route('price.desc.prop') }}" class="text-decoration-none  view-list px-3">By Price Descending</a>
                        </div>
